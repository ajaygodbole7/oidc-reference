...
| 4.14 | Audit on reuse | ✅ | `InternalRefreshController` emits `SecurityAudit.event(... "refresh_token_reuse", "session_invalidated", subjectClaim)` with `sid_hash` (never the raw sid) before the 409. |
