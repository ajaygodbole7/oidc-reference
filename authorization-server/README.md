...
- Discovery:
  `http://localhost:8080/realms/oidc-reference/.well-known/openid-configuration`
- BFF client (confidential): `oidc-reference-bff`
  (redirect `http://127.0.0.1:5173/auth/callback/idp`)
